        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5 border rounded shadow-sm ">
              ...
              <form class="pt-3" method="post" action="assets/php/actions.php?splsignup" >
                ...
                <div class="form-group">
                  <select name="profession" class="form-control form-control-lg"  id="exampleFormControlSelect2">
                    <option value="0" <?=isset($_SESSION['formdata'])?'':'selected'?> >PROFESSION</option>
                    <option value="1" <?=showFormData('profession')==1?'selected':''?>>DIRECTOR</option>
                    <option value="2" <?=showFormData('profession')==2?'selected':''?>>PRODUCER</option>
                  </select>
